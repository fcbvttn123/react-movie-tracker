        ...
        <div>
            {
                ...
                <div className="mt-3">
                    ...
                    <div className="flex items-center overflow-auto">{topRated.map(e => <MovieCards key={e.id} imgName={e.backdrop_path} title={e.title}/>)}</div>
                </div>
            }
            {
                nowPlaying && 
                <div className="mt-3">
                    ...
                    <div className="flex items-center overflow-auto">{nowPlaying.map(e => <MovieCards key={e.id} imgName={e.backdrop_path} title={e.title}/>)}</div>
                </div>
            }
            {
                upcoming && 
                <div className="mt-3">
                    ...
                    <div className="flex items-center overflow-auto">{upcoming.map(e => <MovieCards key={e.id} imgName={e.backdrop_path} title={e.title}/>)}</div>
                </div>
            }
        </div>
    )
